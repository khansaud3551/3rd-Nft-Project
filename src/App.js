  ...
  function progressBar() {
    ...
    function frame() {
      if (width >= 100) {
        ...
        width++;
        //change he width of the progress bar using react ref
                    ...
                    <div className="bg">
                      <div className="social_icons">
                        ...
                        >
                          <a
                            ...
                            rel="noreferrer"
                          >
                            <i className="bi bi-twitter sd nav__icon" />
                          </a>
                        </motion.li>
                      ...
                      <div className="bg_inner">
                        <div>
                          ...
                          {/* //show the text with opacity 0 and then animate it to */}
                          ...
                          <motion.p
                            ...
                            transition={{ duration: 3 }}
                          >
                            The Ultimate 9999 NFT Collection
                          </motion.p>
                        </div>
