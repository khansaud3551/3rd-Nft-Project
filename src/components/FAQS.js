  ...
  return (
    <div className="container-fluid px-0 section_marg">
      ...
      >
        ...
        <h2>1. What's the mission of Crypto Fkers?</h2>
        ...
        <p>There are 10,000 in total and no more will be created.</p>

        <h2>4. What's the max mint limit?</h2>
        <p>Maximum mint limit is 10.</p>
        ...
        <h2>6. When do I expect to get those 2 extra Fkers NFT drop?</h2>
        <p className="m-0 pb-3">
          You will get the Fkers Derivative NFT in Q3 and the Fkers Apparel NFT
          in Q4 2022.
        </p>

        <h2>7. What are the funds being used for?</h2>
        <p className="m-0 pb-3">
        ...
        <h2>8. What's the royalties on Opensea?</h2>
        <p className="m-0 pb-3">
